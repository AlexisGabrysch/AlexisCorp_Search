...
class Corpus:
    ...
    def __init__(self, nom):
        ...
        self.authors = {}   # Autheurs

        self.aut2id = {}    # Id d'autheur
...
# ============ Fonction RECHERCHE_PAR_SIMILARITE_COSINUS pour la recherche de documents  ============ 
    ...
    def recherche_par_similarite_cosinus(self, n=5):
        ...
        for rank, doc_index in enumerate(indices[:n]):      # Affichage des N premiers resultats
            ...
            if doc_index[1]>0:          # Index positif

                print(f"{rank +1}. {self.id2doc[doc_index[0]].titre} (similarity = {doc_index[1]:.2f}) URL = {self.id2doc[doc_index[0]].url}")
